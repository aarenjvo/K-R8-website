    ...
    return (
        <Fragment>
            ...
            <header className="flex justify-between rounded-t-lg text-slate-950 md:pt-3 md:pb-10 md:px-5 pb-5 px-0 mx-0 w-full bg-white drop-shadow-md border border-slate-300">
                ...
                {isMenuOpen && (
                    <div id='hamburger-menu' className={`absolute rounded-lg xl:hidden top-20 left-0 w-full bg-white flex flex-col items-center gap-1 font-semibold text-lg transform transition-transform ${isMenuOpen ? "opacity-100" : "opacity-0"}`}
